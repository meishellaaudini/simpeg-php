...
if (isset($_POST['ubah'])) {
    if (ubah_akun($_POST) > 0) {
        // pesan berhasil
        echo "<script>
                alert('Data Akun Berhasil Ubah'); 
                document.location.href = 'daftar-akun.php';
             </script>";
    } else {
        // pesan gagal
        echo "<script>
                alert('Data Akun Gagal Ubah');
                document.location.href = 'daftar-akun.php';
             </script>";
    }
}
                                    ...
                                    <tr>
                                        ...
                                        <td width="15%" class="text-center">
                                            <button class="btn btn-success btn-sm mb-1" data-toggle="modal" data-target="#modalUbah<?= $data['id_akun']; ?>"><i class="fas fa-edit"></i>
                                                Ubah</button>
                                            <a href="hapus-akun.php?id_akun=<?= $data['id_akun']; ?>" class="btn btn-danger btn-sm mb-1" onclick="return confirm('Yakin Data Akan Dihapus.?');"><i class="fas fa-trash-alt"></i>
                                                Hapus</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <input type="checkbox" class="form-checboks"> <small>Lihat Password</small>
...
<!-- Modal Ubah -->
<?php foreach ($akun as $data) : ?>
    <div class="modal fade" id="modalUbah<?php echo $data['id_akun']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="nama">Nama</label>
                            <input type="text" name="nama" id="nama" class="form-control" required minlength="3" value="<?php echo $data['nama'] ?>">
                        </div>

                        <div class="form-group">
                            <label for="nama">No Telepon</label>
                            <input type="number" name="no_telepon" id="no_telepon" class="form-control" required minlength="3" value="<?php echo $data['no_telepon']?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="role" id="role" class="form-control" required>
                                ...
                                <option value="2" <?= $role == '1' ? : null ?>>Operator</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="password2">password <small>(Masukkan Password Lama/Baru)</small></label>
                            <input type="password" name="password2" id="password2" class="form-control" minlength="6" required>
                        </div>

                        <input type="checkbox" class="form-checboks show-ubah<?= $data['id_akun']; ?>"> <small>Lihat Password</small>
